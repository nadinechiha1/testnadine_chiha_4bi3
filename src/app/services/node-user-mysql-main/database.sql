...
INSERT IGNORE INTO ateliers (nom, emailFormateur, nbrParticipant, statut) VALUES
('Atelier Angular', 'trainer@example.com', 20, 1),
('Atelier TypeScript', 'ts.trainer@example.com', 25, 1),
('Atelier Reactive Forms', 'forms.trainer@example.com', 18, 1);